...
def get_calendar_client(account: str) -> CalendarClient:
    """Get a Calendar client for the specified account."""
...
# Register all tools
register_tools(server, get_calendar_client, get_auth_manager)
...
def main():
    ...
    auth_parser.add_argument(
        "--account", required=True, help="Account name (e.g., 'personal', 'work')"
    )
    auth_parser.add_argument(
        "--credentials-file",
        type=Path,
